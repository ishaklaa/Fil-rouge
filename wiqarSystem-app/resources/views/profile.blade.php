                ...
                <div
                    ...
                    <div class="p-5 overflow-y-auto scroll-y">
                        <form action="{{ route('profiles.store') }}" method="POST" class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label
                                    class="text-xs font-medium text-brown-300 tracking-wide uppercase">Password</label>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <select name="role_id" id="role_select"
                                    ...
                                    <option value="" disabled {{ old('role_id') ? '' : 'selected' }}>Select a role
                                    </option>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <select name="branch_id"
                                    ...
                                    <option value="" disabled {{ old('branch_id') ? '' : 'selected' }}>Select a branch
                                    </option>
                    ...
                    @forelse($users as $user)
                        <div class="profile-card bg-white rounded-2xl border border-beige-200 p-4 flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-xl bg-brown-400 flex items-center justify-center shrink-0">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-xs text-brown-300 font-medium">{{ $user->branch->name ?? '—' }}</span>
                                </div>
                                @if($user->role_id == 3 && $user->shifts->isNotEmpty())
                                    @foreach($user->shifts as $shift)
                                        <div class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-beige-400 shrink-0" fill="none"
                                                 stroke="currentColor"
                                                 stroke-width="2" viewBox="0 0 24 24">
                ...
                {{ \Carbon\Carbon::parse($shift->created_at)->format('H:i') }} — {{ \Carbon\Carbon::parse($shift->ends_at)->format('H:i') }}
                    ...
                    @empty
                        <div class="col-span-full flex flex-col items-center justify-center gap-3 py-24 text-beige-400">
                            ...
                            <p class="text-sm text-center">No profiles yet.<br>Create one on the left to get started.
                            </p>
                        </div>
                    @endforelse
