...
<div class="md:hidden flex items-center justify-between px-4 py-3 bg-brown-400 shadow-lg sticky top-0 z-30">
    ...
    <span class="text-beige-400 text-xs font-light tracking-widest uppercase">Statistics</span>
</div>
...
<div class="flex md:h-screen md:overflow-hidden">
    ...
    <div class="flex-1 overflow-y-auto scroll-y p-4 md:p-6 flex flex-col gap-6">
        ...
        <div class="bg-white rounded-2xl border border-beige-200 shadow-sm p-4 md:p-5 flex flex-col gap-4">
                ...
                @forelse($activities as $activity)
                    @forelse($activity->orders as $order)
                        <div class="order-card bg-beige-50 rounded-2xl border border-beige-200 overflow-hidden">
                            <div class="px-4 md:px-5 py-4 flex items-start sm:items-center gap-3 md:gap-4">

                                <div class="w-10 h-10 rounded-xl bg-white border border-beige-200 flex items-center justify-center shrink-0">
                                ...
                                <div class="flex flex-wrap items-center justify-end gap-2 shrink-0">
                                    ...
                                    <span class="font-playfair font-bold text-brown-300 text-sm whitespace-nowrap">{{ $activity->price }} SAR</span>
                                    <span class="text-xs font-medium text-brown-300 bg-white border border-beige-300 rounded-lg px-2.5 py-1.5 whitespace-nowrap">
                                        Order #{{ $order->id }}
                                    </span>
                                </div>
