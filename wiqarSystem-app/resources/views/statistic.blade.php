...
<head>
    ...
    <style>
        ...
        .order-card:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(61,36,16,0.12); }
                        ...
                        <div class="order-card bg-beige-50 rounded-2xl border border-beige-200 overflow-hidden">
                            <div class="px-5 py-4 flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-3 shrink-0">
                                    ...
                                    <span class="text-xs font-medium text-brown-300 bg-white border border-beige-300 rounded-lg px-3 py-1.5">
                                        Order #{{ $order->id }}
                                    </span>
                                </div>
                            </div>
