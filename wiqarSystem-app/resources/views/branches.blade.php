                    ...
                    <div class="p-5 overflow-y-auto scroll-y">
                        <form action="{{ route('branches.store') }}" method="POST" class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label class="text-xs font-medium text-brown-300 tracking-wide uppercase">Branch
                                    Name</label>
            ...
            <div class="flex flex-col gap-4 flex-1 overflow-hidden">
                ...
                <div class="flex flex-col gap-3 overflow-y-auto scroll-y pr-1 flex-1 content-start">
                    ...
                    @forelse($branches as $branch)
                        <div
                            class="branch-card bg-white rounded-2xl border border-beige-200 px-5 py-4 flex items-center gap-4">

                            <!-- Icon -->
                            <div
                                class="w-11 h-11 rounded-xl bg-beige-100 border border-beige-200 flex items-center justify-center shrink-0">
                                <svg class="w-5 h-5 text-brown-300" fill="none" stroke="currentColor" stroke-width="2"
                                     viewBox="0 0 24 24">
                                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
                                    <polyline points="9 22 9 12 15 12 15 22"/>
                                </svg>
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center gap-3 py-24 text-beige-400">
                            ...
                            <p class="text-sm text-center">No branches yet.<br>Create one on the left to get started.
                            </p>
                        </div>
                    @endforelse
